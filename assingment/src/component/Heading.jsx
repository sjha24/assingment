...
const Heading = () => {
  return (
    <div>
        <div className='uper_heading'>
            <Typography style={{display:"flex", justifyContent:"center",fontFamily: "Inter",fontSize: "48px",
            fontWeight: "400",lineHeight: "60px",letterSpacing: "0em",textAlign: "left",marginTop:"20px"}}>
            ...
            <div className='line'>
                <div className='upper_line'></div>
                    <div className="headerBottam">
                        <div className="hb_left_side">
                            <span className='text' style={{fontSize:"14px"}}>
                                <svg className='icon' width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
